...
export const metadata: Metadata = {
  ...
  description:
    "I'm a Full Stack Developer who enjoys building products that solve real-world problems. I specialize in creating MVPs quickly and efficiently. Explore my work, experience, and technical expertise.",
  icons: {
